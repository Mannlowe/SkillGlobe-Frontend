...
export default function SettingsPage() {
  ...
  const Sidebar = ({ isOpen, onClose }: SidebarProps) => (
    <div className={`fixed inset-y-0 left-0 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} w-64 bg-white shadow-lg transition-transform duration-300 ease-in-out z-30 md:relative md:translate-x-0`}>
      <div className="p-4">
        <h2 className="text-xl font-bold">SkillGlobe</h2>
        <nav className="mt-8">
  ...
  // Define prop types for DashboardHeader
